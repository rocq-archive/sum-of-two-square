...
Theorem ulist_map:
 ...
 (forall x y, f x = f y ->  x = y) -> ulist l ->  ulist (map f l).
intros a b f l Hf Hl; elim Hl; auto.
simpl; auto.
intros a1 l1 H1 H2 H3; simpl.
apply ulist_cons; auto.
contradict H1.
case in_map_inv with ( 1 := H1 ); auto with zarith.
intros b1 [Hb1 Hb2].
replace a1 with b1; auto.
Qed.
